...
[![pypi](https://img.shields.io/pypi/v/xagg_new.svg)](https://pypi.org/project/xagg_new)
<!-- [![conda-forge](https://img.shields.io/conda/dn/conda-forge/xagg_new?label=conda-forge)](https://anaconda.org/conda-forge/xagg_new) -->[![Documentation Status](https://readthedocs.org/projects/xagg_new/badge/?version=latest)](https://xagg_new.readthedocs.io/en/latest/?badge=latest)
...
## Installation 
`xagg` can be installed easily via `pip`:
